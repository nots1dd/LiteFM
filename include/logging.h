 ...
 * ---------------------------------------------------------------------------
 *  File:        logging.h
 *  Description: This header file provides the interface for logging functionality 
 *                in the LiteFM file manager. It includes declarations for functions 
 *                to manage logging, including creating necessary directories and 
 *                files, and writing log messages with various levels of severity.
 *
 ...
 *  IMPORTANT NOTE ::
 *
 *  If you do not have $HOME/.cache/litefm/log/litefm.log and did not use `build.sh`,
 *  it may break LiteFM! Ensure that you have that directory created by running 
 *  `build.sh` for LiteFM to function correctly.
 * 
 ...
 *                system permissions allow the creation and modification of files 
